		...
		<div className="BlockList">
			<AnimatePresence>
				{blockList.map((block) => {
					...
					keys.push(key);
					return (
						<motion.div {...animations} key={key} className="BlockCard" layout>
							<div className="BlockCardBackground">
								<div className="left">
									...
									<div className="infos">
										<div className="infosTitle">{block.number.toNumber()}</div>
										<div className="infosDate">12sec ago.</div>
									</div>
								</div>
								{type === "block" && (
									<div className="center">
										<div className="title">beaverbuild</div>
										<div className="infos">
